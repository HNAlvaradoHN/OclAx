...
- PICKER-001 permanece **IMPLEMENTED_PENDING_VALIDATION**: apertura/presentación, navegación por tarjetas, cancelar y permiso de almacenamiento negado/revocado ya fueron confirmados físicamente. Falta ampliar la validación de devolución efectiva de archivos a la aplicación llamadora. La selección múltiple existente es compatibilidad técnica del intent externo, no una función de producto propuesta por el dueño ni un gate prioritario.
