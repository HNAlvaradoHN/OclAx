...
Aclaración:
- la primera implementación de la etapa 1 es una **prueba LAN explícita**: local discovery solo durante la búsqueda y TCP para la sesión, con peer limitado a redes privadas; global discovery, relay y NAT permanecen apagados;
