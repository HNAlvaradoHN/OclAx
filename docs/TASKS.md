...
7. **CORRECCIÓN IMPLEMENTADA_PENDIENTE_CI_Y_VALIDACIÓN:** el runtime Android ejecuta Syncthing como proceso interno ya supervisado (`STMONITORED=1`), usa almacenamiento temporal privado para SQLite; una prueba unitaria fija este contrato.
...
11. recién después conectar progreso/cancelación/reintento y la UX visible **Enviar a dispositivo**.
